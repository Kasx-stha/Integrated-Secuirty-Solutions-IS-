...
HOME_NET = '192.168.196.128/24'

-- set up the external network addresses.
-- (leave as "any" in most situations)
EXTERNAL_NET = 'any'

HTTP_PORTS = { 80, 8080, 5000, 9000 }
...
binder =
{
    ...
    { when = { proto = 'tcp', ports = HTTP_PORTS, role='server' }, use = { type = 'http_inspect' } },
...
daq = {
    ...
    }  -- Add this closing brace to correctly close the modules block
}
...
-- this to enable payload injection utility
-- payload_injector = {}
...
{
        type = 'log_json',
        filename = '/usr/local/etc/snort/snort.json'
}
